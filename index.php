...
<head>
	...
	<script type="text/javascript" src="//<?php echo getConfig('app', 'static'); ?>/server/get.php?l=en&amp;t=js&amp;f=common.js~system.js~utilities.js~browser-detect.js~constants.js~datastore.js~jsjac.js~jquery.placeholder.js~date.js"></script>
...
<body>
	...
	<div id="foot" class="wrapped">
		<span><b><a href="https://project.jappix.com/contact">Contact</a></b> - <b><a href="https://legal.jappix.com/">Legal</a></b> - © 2011-<?php echo(date('Y')); ?> <a href="https://jappix.com/">Jappix</a></span>
		<?php if($page == 'user') {
		...
		<span class="right"><a class="logo" href="https://jappix.com/">Jappix</a> - <a href="https://me.jappix.com/">Jappix Me</a> - <a href="https://project.jappix.com/">Jappix Download</a></span>
		<?php } ?>
		<div class="clear"></div>
	</div>
	<?php } ?>
