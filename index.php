...
<body>
	...
	<div id="foot" class="wrapped">
		<span><b><a href="https://project.jappix.com/contact">Contact</a></b> - <b><a href="https://legal.jappix.com/">Legal</a></b> - © 2011-<?php echo(date('Y')); ?> <a href="https://project.jappix.com/">Jappix</a></span>
		<?php if($page == 'user') {
